...
/*
 *  
 *  Q.2. Write a program that displays the temperatures from 0 degrees Celsius 
 *  to 100 degrees Celsius and its Fahrenheit equivalent.
 *  Note that the conversion from Celsius to Fahrenheit uses the 
...
public class TemperatureList {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i <= 100; i++) {
			...
			System.out.println((i+1)+space+i+"°C"+"       "+fah_scale+"°F");
		}
